...
import profileImg from "../assets/zeanur-rahaman-zeon.jpg";
  ...
  return (
    ...
    >
      <div className="flex flex-col-reverse lg:flex-row lg:pl-16 items-center justify-between gap-12">
        ...
        >
          <motion.div
            ...
            className="space-y-2"
          >
            <p className="text-lg text-secondary uppercase">Hello, I'm</p>
          ...
          <motion.p
            ...
            className="text-lg  max-w-xl mx-auto lg:mx-0 leading-relaxed"
          >
            I build scalable and dynamic web applications using modern
            technologies like React, Node.js, and MongoDB. I love clean UI,
            strong UX, and writing maintainable code.
          </motion.p>
          ...
          >
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-12 h-12 bg-card/80 backdrop-blur-sm border rounded-full shadow-lg flex items-center justify-center  hover:text-primary hover:border-primary/50 transition-all duration-200"
              >
                <Icon size={20} />
              </motion.a>
            ))}
          ...
          >
            ...
            <a
              href="#contact"
              className="px-6 py-3 border-2 border-primary font-medium rounded-lg"
            >
              Let's Talk
            </a>
          </motion.div>
        ...
        >
          <div className="relative">
            <motion.div
              ...
              className="w-72 h-72 lg:w-80 lg:h-80 rounded-full gradient-bg flex items-center justify-center shadow-2xl border/20"
            >
              <div className="w-64 h-64 lg:w-72 lg:h-72 rounded-full overflow-hidden border-4 border-card shadow-xl">
                <img
                  src={profileImg}
                  alt="Zeon's Profile"
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-12 w-16 h-16 shadow-lg -z-30"
            >
              <svg
            ...
            <motion.div
              ...
              className="absolute -bottom-20 -left-6 shadow-inner text-yellow-200"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
      ...
      <motion.div
        ...
        className="absolute bottom-2 md:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2"
      >
